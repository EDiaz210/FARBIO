    ...
    <div className="min-h-full overflow-auto font-sans" style={{ fontFamily: 'Gowun Batang, serif' }}>
      <div className="w-full bg-yellow-100">
        <div className="px-6 lg:px-8 py-4 lg:py-5">
          <h1 className="text-4xl font-bold text-black">Bandeja de Contabilidad</h1>
          <p className="text-sm text-black-700 mt-1">Códigos pendientes para revisión contable</p>
        </div>
      </div>
...
export default ContabilidadTablaCodigos;
