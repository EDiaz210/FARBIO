...
const CrearUsuario = ({ token, onSuccess, onCancel }) => {
  ...
  return (
    <div className="bg-[#f8f9fa] p-8 rounded-lg mb-8 border border-gray-200">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-[#17243D]">Crear Nuevo Usuario</h2>
          <p className="text-gray-600 mt-1">Completa la información para registrar un usuario nuevo.</p>
        </div>
        <button
          onClick={onCancel}
